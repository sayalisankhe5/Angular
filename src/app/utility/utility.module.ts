...
@NgModule({
    declarations:[BasicCalculatorComponent,CalculatorComponent,ComputationSummaryComponent, SearchResultComponentComponent, SearchComponent],
    imports:[WidgetsModule,FormsModule],
    exports:[BasicCalculatorComponent,SearchComponent,SearchResultComponentComponent],
